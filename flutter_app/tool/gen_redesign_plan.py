    ...
    for i, row in enumerate(batch_rows):
        ...
        lines.extend(
            [
                ...
                *load_lines,
                "",
                "STEP 0→5. Batch gọn theo scope. New chat next batch.",
                f"Completion: {comp}",
                "```",
                module_gate,
                "",
...
def render_slim_markdown(
    ...
    lines = [
        ...
        "",
        "**Nguồn chuẩn:** các lệnh verify trong `AI_PROMPT_SHELL.md` và skill agent áp dụng cho batch.",
        "",
