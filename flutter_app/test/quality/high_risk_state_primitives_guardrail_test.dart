...
void main() {
  test('representative high-risk pages use shared state primitives', () {
    const targets = {
      ...
      'lib/features/p2p_marketplace/presentation/widgets/phone/p2p_home_page_state.dart',
      'lib/features/p2p_dispute/presentation/phone/pages/dispute/p2p_dispute_resolution_page.dart',
      'lib/features/earn_staking/presentation/phone/pages/staking/staking_earn_page.dart',
      'lib/features/launchpad/presentation/phone/pages/bridge/launchpad_bridge_order_page.dart',
      ...
      'lib/features/profile/presentation/phone/pages/security_page.dart',
      'lib/features/p2p_account/presentation/phone/pages/payment/p2p_payment_method_add_page.dart',
      'lib/features/p2p_account/presentation/phone/pages/payment/p2p_payment_method_ownership_page.dart',
      'lib/features/p2p_account/presentation/phone/pages/payment/p2p_payment_method_cooling_period_page.dart',
