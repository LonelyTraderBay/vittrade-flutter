  ...
  Widget build(BuildContext context) {
    ...
    return snapshotAsync.when(
      ...
      data: (snapshot) => VitTabletSectionFrame(
        ...
        contentKey: P2POrderRateTabletPage.contentKey,
        children: [
          VitCard(
          ...
          VitCtaButton(
            ...
            onPressed: () => context.push(AppRoutePaths.p2pMyOrders),
  ...
  Widget build(BuildContext context) {
    ...
    return snapshotAsync.when(
      ...
      data: (snapshot) => VitTabletSectionFrame(
        ...
        contentKey: P2POrderCancelTabletPage.contentKey,
        children: [
          VitCard(
            radius: VitCardRadius.tight,
            padding: TabletSpacingTokens.cardPaddingCompact,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return snapshotAsync.when(
      ...
      data: (snapshot) => VitTabletSectionFrame(
        ...
        contentKey: P2POrderProofTabletPage.contentKey,
        children: [
          Text(
