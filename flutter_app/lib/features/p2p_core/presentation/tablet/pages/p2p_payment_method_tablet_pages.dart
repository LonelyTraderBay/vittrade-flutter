...
/// Khuôn chung các trang payment method P2P tablet (1080dp + high-risk panel).
Widget p2pPaymentPageFrame({
      ...
      children: [
        VitHeader(
          ...
          onBack: showBack
              ? () => goBackOrFallback(
                  context,
                  fallbackPath: AppRoutePaths.p2pSettings,
          ...
          children: [
            Row(
              children: [
                ...
                VitCtaButton(
                  fullWidth: false,
                  onPressed: () => context.go(snapshot.addBankRoute),
                ...
                VitCtaButton(
                  ...
                  onPressed: () => context.go(snapshot.addEwalletRoute),
