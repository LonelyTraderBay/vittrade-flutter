        ...
        children: [
          _esvSection(
            ...
            rows: _esvRows([
              ...
              ('Vốn khả dụng', VitFormat.usd(snapshot.profile.totalAvailable)),
              (
                'Tài sản ưa thích',
            ...
            _esvSection(
              ...
              rows: [
                ...
                ..._esvRows([
                  ...
                  (
                    'APY kỳ vọng',
                    VitFormat.percent(strategy.expectedApy, fractionDigits: 2),
                  ),
          ...
          _esvSection(title: 'Miễn trừ', rows: [_esvBody(snapshot.disclaimer)]),
        ],
      ),
    );
  }
