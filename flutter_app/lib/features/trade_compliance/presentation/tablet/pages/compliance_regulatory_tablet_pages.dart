...
class TransactionReportingTabletPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return snapshotAsync.when(
      ...
      error: (error, stackTrace) => _cregFrame(
        context: context,
          ...
          children: [
            _cregSection(
              ...
              rows: _cregRows([
                ...
                (
                  'Giá trị tổng',
                  snapshot.summary.totalValue.toStringAsFixed(2),
                ),
                (
                  'Điểm trung bình',
                  snapshot.summary.avgScore.toStringAsFixed(1),
                ),
              ]),
            ),
            const SizedBox(height: TabletSpacingTokens.x3),
            ...
            for (final venue in snapshot.venues) ...[
              _cregSection(
                ...
                rows: _cregRows([
                  ...
                  (
                    'Tác động thị trường',
                    venue.marketImpact.toStringAsFixed(3),
                  ),
