...
const double _walletToolGridGap = TabletSpacingTokens.x2;
const double _walletDcaIcon = TabletSpacingTokens.iconLg;
const double _walletDcaStatIcon = TabletSpacingTokens.iconMd;
...
class WalletDcaCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VitCard(
      ...
      borderColor: _walletPurple.withValues(alpha: .22),
      child: Column(
        children: [
          Row(
            children: [
