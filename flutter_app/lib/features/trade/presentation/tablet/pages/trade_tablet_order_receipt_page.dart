...
class TradeTabletOrderReceiptPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TradeTabletOrderReceiptPage> createState() =>
      _TradeTabletOrderReceiptPageState();
}

class _TradeTabletOrderReceiptPageState
    extends ConsumerState<TradeTabletOrderReceiptPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return VitTradeDetailScaffold(
      ...
      contentKey: TradeTabletOrderReceiptPage.contentKey,
      shellRenderMode: mode,
      ...
      children: receiptAsync.when(
        ...
        data: (snapshot) {
          ...
          return [
            ...
            VitCtaButton(
              key: TradeTabletOrderReceiptPage.openActionsKey,
