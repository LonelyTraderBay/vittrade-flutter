    ...
    GoRoute(
      ...
      builder: (context, _) => InternalSurfaceGate(
        ...
        child: buildPhoneRoute(
          ...
          description:
              'Theo dõi vận hành và chỉ số quản trị trong giao diện Phone.',
    ...
    GoRoute(
      ...
      builder: (context, _) => InternalSurfaceGate(
        ...
        child: buildPhoneRoute(
          ...
          description: 'Đối chiếu chỉ số và xu hướng vận hành trên Phone.',
    ...
    GoRoute(
      ...
      builder: (context, _) => InternalSurfaceGate(
        ...
        child: buildPhoneRoute(
          ...
          description: 'Theo dõi thử nghiệm và kết quả phân tích trên Phone.',
          backPath: AppRoutePaths.admin,
