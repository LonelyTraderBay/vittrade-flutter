...
List<RouteBase> predictionRoutes(ShellRenderMode shellRenderMode) {
  return [
    GoRoute(
      ...
      builder: (context, _) => _phonePredictionRoute(
        context: context,
...
Widget _phonePredictionRoute({
  ...
  return buildPhoneRoute(
    ...
    subtitle: 'Phân tích và quản trị vị thế trên Phone',
    description:
        'Không gian Phone tập trung cho dữ liệu, vị thế và quyết định có kiểm soát.',
