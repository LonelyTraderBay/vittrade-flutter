...
| P2_visual_density_review | 12 | trade | TradePage | `'/trade/:pairId'` | body B; few dense sections/cards=0 | `flutter_app/lib/features/trade/presentation/pages/phone/trade_page.dart` |
| P2_visual_density_review | 12 | trade | TradeResponsiveEntry | `AppRoutePaths.trade` | body B; few dense sections/cards=0 | `flutter_app/lib/features/trade/presentation/pages/phone/trade_page.dart` |
...
| P2_visual_density_review | 11 | profile | ProfileResponsiveEntry | `AppRoutePaths.profile` | body B | `flutter_app/lib/features/profile/presentation/pages/phone/profile_page.dart` |
...
| P3_followup_review | 9 | wallet | WalletResponsiveEntry | `AppRoutePaths.wallet` | body B | `flutter_app/lib/features/wallet/presentation/pages/phone/wallet_page.dart` |
...
| P3_followup_review | 8 | home | HomeResponsiveEntry | `AppRoutePaths.home` | body B | `flutter_app/lib/features/home/presentation/pages/phone/home_page.dart` |
