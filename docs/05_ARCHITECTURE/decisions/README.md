...
| [ADR-012](ADR-012-p2p-family-split.md) | Tách module P2P thành 7 feature sibling theo họ p2p_* | Đã chốt |
...
| [ADR-014](ADR-014-dark-only-theme.md) | Chính sách theme dark-only: không dựng nhánh light | Đã chốt |
